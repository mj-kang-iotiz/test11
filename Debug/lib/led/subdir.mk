...
lib/led/%.o lib/led/%.su lib/led/%.cyclo: ../lib/led/%.c lib/led/subdir.mk
...
clean: clean-lib-2f-led

clean-lib-2f-led:
	-$(RM) ./lib/led/led.cyclo ./lib/led/led.d ./lib/led/led.o ./lib/led/led.su

.PHONY: clean-lib-2f-led
