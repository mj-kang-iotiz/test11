...
C_SRCS += \
../app/params/flash_params.c 

OBJS += \
./app/params/flash_params.o 

C_DEPS += \
./app/params/flash_params.d 


# Each subdirectory must supply rules for building sources it contributes
app/params/%.o app/params/%.su app/params/%.cyclo: ../app/params/%.c app/params/subdir.mk
...
clean: clean-app-2f-params

clean-app-2f-params:
	-$(RM) ./app/params/flash_params.cyclo ./app/params/flash_params.d ./app/params/flash_params.o ./app/params/flash_params.su

.PHONY: clean-app-2f-params
